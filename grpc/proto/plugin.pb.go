...
type SetConnectionConfigRequest struct {
	...
	MaxCacheCostMb   int32  `protobuf:"varint,3,opt,name=max_cache_cost_mb,json=maxCacheCostMb,proto3" json:"max_cache_cost_mb,omitempty"`
}
...
func (x *SetConnectionConfigRequest) GetMaxCacheCostMb() int32 {
	if x != nil {
...
var file_plugin_proto_rawDesc = []byte{
	...
	0x28, 0x05, 0x52, 0x0e, 0x6d, 0x61, 0x78, 0x43, 0x61, 0x63, 0x68, 0x65, 0x43, 0x6f, 0x73, 0x74,
