...
type BoolQual_Operator int32

const (
	BoolQual_EQ  BoolQual_Operator = 0
	BoolQual_NE  BoolQual_Operator = 1
	BoolQual_AND BoolQual_Operator = 2
	BoolQual_OR  BoolQual_Operator = 3
)

// Enum value maps for BoolQual_Operator.
var (
	BoolQual_Operator_name = map[int32]string{
		0: "EQ",
		1: "NE",
		2: "AND",
		3: "OR",
	}
	BoolQual_Operator_value = map[string]int32{
		"EQ":  0,
		"NE":  1,
		"AND": 2,
		"OR":  3,
...
func (x BoolQual_Operator) Enum() *BoolQual_Operator {
	p := new(BoolQual_Operator)
	*p = x
	return p
}

func (x BoolQual_Operator) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (BoolQual_Operator) Descriptor() protoreflect.EnumDescriptor {
	return file_plugin_proto_enumTypes[3].Descriptor()
}

func (BoolQual_Operator) Type() protoreflect.EnumType {
	return &file_plugin_proto_enumTypes[3]
}

func (x BoolQual_Operator) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use BoolQual_Operator.Descriptor instead.
func (BoolQual_Operator) EnumDescriptor() ([]byte, []int) {
...
type Qual struct {
	...
	// Types that are assignable to OperatorDeprecated:
	//	*Qual_StringValue
	//	*Qual_TupleValue
	OperatorDeprecated isQual_OperatorDeprecated `protobuf_oneof:"operator_deprecated"`
...
func (m *Qual) GetOperatorDeprecated() isQual_OperatorDeprecated {
	if m != nil {
		return m.OperatorDeprecated
	}
	return nil
}
...
func (x *Qual) GetStringValue() string {
	if x, ok := x.GetOperatorDeprecated().(*Qual_StringValue); ok {
...
func (x *Qual) GetTupleValue() *Operator {
	if x, ok := x.GetOperatorDeprecated().(*Qual_TupleValue); ok {
		return x.TupleValue
	}
	return nil
}
...
func (x *Qual) GetOperator() string {
	if x != nil {
		return x.Operator
	}
	return ""
...
type isQual_OperatorDeprecated interface {
	isQual_OperatorDeprecated()
}
...
func (*Qual_StringValue) isQual_OperatorDeprecated() {}

func (*Qual_TupleValue) isQual_OperatorDeprecated() {}
...
type DbQual struct {
	...
	// Types that are assignable to DbQual:
	//	*DbQual_Qual
	//	*DbQual_BoolQual
	DbQual isDbQual_DbQual `protobuf_oneof:"dbQual"`
}
...
func (x *DbQual) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DbQual) ProtoMessage() {}

func (x *DbQual) ProtoReflect() protoreflect.Message {
	mi := &file_plugin_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DbQual.ProtoReflect.Descriptor instead.
func (*DbQual) Descriptor() ([]byte, []int) {
	return file_plugin_proto_rawDescGZIP(), []int{2}
}

func (m *DbQual) GetDbQual() isDbQual_DbQual {
	if m != nil {
		return m.DbQual
	}
	return nil
...
func (x *DbQual) GetQual() *Qual {
	if x, ok := x.GetDbQual().(*DbQual_Qual); ok {
		return x.Qual
	}
	return nil
}

func (x *DbQual) GetBoolQual() *BoolQual {
	if x, ok := x.GetDbQual().(*DbQual_BoolQual); ok {
		return x.BoolQual
	}
	return nil
}

type isDbQual_DbQual interface {
	isDbQual_DbQual()
}

type DbQual_Qual struct {
	Qual *Qual `protobuf:"bytes,1,opt,name=qual,proto3,oneof"`
}

type DbQual_BoolQual struct {
	BoolQual *BoolQual `protobuf:"bytes,2,opt,name=boolQual,proto3,oneof"`
}

func (*DbQual_Qual) isDbQual_DbQual() {}

func (*DbQual_BoolQual) isDbQual_DbQual() {}
...
type DbQuals struct {
	...
	Quals []*DbQual `protobuf:"bytes,1,rep,name=quals,proto3" json:"quals,omitempty"`
}

func (x *DbQuals) Reset() {
	*x = DbQuals{}
	if protoimpl.UnsafeEnabled {
...
func (x *DbQuals) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DbQuals) ProtoMessage() {}

func (x *DbQuals) ProtoReflect() protoreflect.Message {
	mi := &file_plugin_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DbQuals.ProtoReflect.Descriptor instead.
func (*DbQuals) Descriptor() ([]byte, []int) {
	return file_plugin_proto_rawDescGZIP(), []int{3}
}

func (x *DbQuals) GetQuals() []*DbQual {
	if x != nil {
		return x.Quals
	}
	return nil
...
type BoolQual struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Operator BoolQual_Operator `protobuf:"varint,2,opt,name=operator,proto3,enum=proto.BoolQual_Operator" json:"operator,omitempty"`
	Quals    *DbQuals          `protobuf:"bytes,3,opt,name=quals,proto3" json:"quals,omitempty"`
}

func (x *BoolQual) Reset() {
	*x = BoolQual{}
	if protoimpl.UnsafeEnabled {
...
func (x *BoolQual) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BoolQual) ProtoMessage() {}

func (x *BoolQual) ProtoReflect() protoreflect.Message {
	mi := &file_plugin_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BoolQual.ProtoReflect.Descriptor instead.
func (*BoolQual) Descriptor() ([]byte, []int) {
	return file_plugin_proto_rawDescGZIP(), []int{4}
}

func (x *BoolQual) GetOperator() BoolQual_Operator {
	if x != nil {
		return x.Operator
	}
	return BoolQual_EQ
...
func (x *BoolQual) GetQuals() *DbQuals {
	if x != nil {
		return x.Quals
	}
	return nil
...
type QueryContext struct {
	...
	DbQuals map[string]*DbQuals `protobuf:"bytes,3,rep,name=db_quals,json=dbQuals,proto3" json:"db_quals,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (x *QueryContext) GetDbQuals() map[string]*DbQuals {
	if x != nil {
		return x.DbQuals
	}
	return nil
...
var file_plugin_proto_rawDesc = []byte{
	...
	,
	...
	0x6f, 0x6f, 0x6c, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x12, 0x2c, 0x0a, 0x0a, 0x69, 0x6e, 0x65, 0x74,
	0x5f, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0b, 0x2e, 0x70,
	0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x49, 0x6e, 0x65, 0x74, 0x48, 0x00, 0x52, 0x09, 0x69, 0x6e, 0x65,
	0x74, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x12, 0x21, 0x0a, 0x0b, 0x6a, 0x73, 0x6f, 0x6e, 0x62, 0x5f,
	0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x48, 0x00, 0x52, 0x0a, 0x6a,
	0x73, 0x6f, 0x6e, 0x62, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x12, 0x45, 0x0a, 0x0f, 0x74, 0x69, 0x6d,
	0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x5f, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x07, 0x20, 0x01,
	...
	0x12, 0x35, 0x0a, 0x0a, 0x6c, 0x69, 0x73, 0x74, 0x5f, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x08,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x51, 0x75, 0x61,
	0x6c, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x4c, 0x69, 0x73, 0x74, 0x48, 0x00, 0x52, 0x09, 0x6c, 0x69,
	0x73, 0x74, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x42, 0x07, 0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65,
	0x22, 0x6d, 0x0a, 0x04, 0x49, 0x6e, 0x65, 0x74, 0x12, 0x12, 0x0a, 0x04, 0x6d, 0x61, 0x73, 0x6b,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x04, 0x6d, 0x61, 0x73, 0x6b, 0x12, 0x12, 0x0a, 0x04,
	...
	0x63, 0x69, 0x64, 0x72, 0x12, 0x29, 0x0a, 0x10, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c,
	...
	,
	...
	,
	...
	0x52, 0x03, 0x72, 0x6f, 0x77, 0x22, 0x12, 0x0a, 0x10, 0x47, 0x65, 0x74, 0x53, 0x63, 0x68, 0x65,
	0x6d, 0x61, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x3a, 0x0a, 0x11, 0x47, 0x65, 0x74,
	0x53, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x25,
	0x0a, 0x06, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0d,
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x53, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x52, 0x06, 0x73,
	0x63, 0x68, 0x65, 0x6d, 0x61, 0x22, 0x72, 0x0a, 0x1a, 0x53, 0x65, 0x74, 0x43, 0x6f, 0x6e, 0x6e,
	...
	0x6e, 0x6e, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x2b, 0x0a, 0x11,
	...
	0x69, 0x6f, 0x6e, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x22, 0x1d, 0x0a, 0x1b, 0x53, 0x65, 0x74,
	0x43, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67,
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x83, 0x01, 0x0a, 0x03, 0x52, 0x6f, 0x77,
	...
	0x75, 0x6d, 0x6e, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xc2,
	0x02, 0x0a, 0x0b, 0x54, 0x61, 0x62, 0x6c, 0x65, 0x53, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x12, 0x31,
	...
	0x69, 0x6f, 0x6e, 0x12, 0x42, 0x0a, 0x11, 0x67, 0x65, 0x74, 0x43, 0x61, 0x6c, 0x6c, 0x4b, 0x65,
	...
	0x73, 0x53, 0x65, 0x74, 0x52, 0x11, 0x67, 0x65, 0x74, 0x43, 0x61, 0x6c, 0x6c, 0x4b, 0x65, 0x79,
	0x43, 0x6f, 0x6c, 0x75, 0x6d, 0x6e, 0x73, 0x12, 0x44, 0x0a, 0x12, 0x6c, 0x69, 0x73, 0x74, 0x43,
	0x61, 0x6c, 0x6c, 0x4b, 0x65, 0x79, 0x43, 0x6f, 0x6c, 0x75, 0x6d, 0x6e, 0x73, 0x18, 0x04, 0x20,
	0x01, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x4b, 0x65, 0x79, 0x43,
	0x6f, 0x6c, 0x75, 0x6d, 0x6e, 0x73, 0x53, 0x65, 0x74, 0x52, 0x12, 0x6c, 0x69, 0x73, 0x74, 0x43,
	0x61, 0x6c, 0x6c, 0x4b, 0x65, 0x79, 0x43, 0x6f, 0x6c, 0x75, 0x6d, 0x6e, 0x73, 0x12, 0x54, 0x0a,
	...
	0x75, 0x6d, 0x6e, 0x73, 0x53, 0x65, 0x74, 0x52, 0x1a, 0x6c, 0x69, 0x73, 0x74, 0x43, 0x61, 0x6c,
	0x6c, 0x4f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x61, 0x6c, 0x4b, 0x65, 0x79, 0x43, 0x6f, 0x6c, 0x75,
	0x6d, 0x6e, 0x73, 0x22, 0x4b, 0x0a, 0x0d, 0x4b, 0x65, 0x79, 0x43, 0x6f, 0x6c, 0x75, 0x6d, 0x6e,
	...
	0x22, 0xd6, 0x01, 0x0a, 0x06, 0x53, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x12, 0x31, 0x0a, 0x06, 0x73,
	...
	0x63, 0x6f, 0x6c, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x1a, 0x4d, 0x0a, 0x0b, 0x53, 0x63,
	...
	0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x88, 0x03, 0x0a, 0x06, 0x43, 0x6f,
	...
	0x72, 0x52, 0x61, 0x6e, 0x67, 0x65, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x42, 0x07, 0x0a, 0x05, 0x76,
	...
	0x70, 0x74, 0x69, 0x6f, 0x6e, 0x2a, 0x1b, 0x0a, 0x09, 0x4e, 0x75, 0x6c, 0x6c, 0x56, 0x61, 0x6c,
	0x75, 0x65, 0x12, 0x0e, 0x0a, 0x0a, 0x4e, 0x55, 0x4c, 0x4c, 0x5f, 0x56, 0x41, 0x4c, 0x55, 0x45,
	0x10, 0x00, 0x2a, 0x8a, 0x01, 0x0a, 0x0a, 0x43, 0x6f, 0x6c, 0x75, 0x6d, 0x6e, 0x54, 0x79, 0x70,
	...
	0x4d, 0x45, 0x53, 0x54, 0x41, 0x4d, 0x50, 0x10, 0x08, 0x12, 0x14, 0x0a, 0x07, 0x55, 0x4e, 0x4b,
	0x4e, 0x4f, 0x57, 0x4e, 0x10, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x01, 0x32,
	0xe9, 0x01, 0x0a, 0x0d, 0x57, 0x72, 0x61, 0x70, 0x70, 0x65, 0x72, 0x50, 0x6c, 0x75, 0x67, 0x69,
	...
	0x66, 0x69, 0x67, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x09, 0x5a, 0x07, 0x2e,
...
var file_plugin_proto_goTypes = []interface{}{
	...
	(BoolQual_Operator)(0),              // 3: proto.BoolQual.Operator
	(*Operator)(nil),                    // 4: proto.Operator
	(*Qual)(nil),                        // 5: proto.Qual
	(*DbQual)(nil),                      // 6: proto.DbQual
	(*DbQuals)(nil),                     // 7: proto.DbQuals
	(*BoolQual)(nil),                    // 8: proto.BoolQual
	...
	(*ExecuteRequest)(nil),              // 14: proto.ExecuteRequest
	...
	(*SetConnectionConfigRequest)(nil),  // 18: proto.SetConnectionConfigRequest
	(*SetConnectionConfigResponse)(nil), // 19: proto.SetConnectionConfigResponse
	(*Row)(nil),                         // 20: proto.Row
	(*TableSchema)(nil),                 // 21: proto.TableSchema
	(*KeyColumnsSet)(nil),               // 22: proto.KeyColumnsSet
	(*Schema)(nil),                      // 23: proto.Schema
	(*Column)(nil),                      // 24: proto.Column
	(*ColumnDefinition)(nil),            // 25: proto.ColumnDefinition
	nil,                                 // 26: proto.QueryContext.QualsEntry
	nil,                                 // 27: proto.QueryContext.DbQualsEntry
	nil,                                 // 28: proto.Row.ColumnsEntry
	nil,                                 // 29: proto.Schema.SchemaEntry
...
var file_plugin_proto_depIdxs = []int32{
	...
	10, // 2: proto.Qual.value:type_name -> proto.QualValue
	5,  // 3: proto.DbQual.qual:type_name -> proto.Qual
	8,  // 4: proto.DbQual.boolQual:type_name -> proto.BoolQual
	6,  // 5: proto.DbQuals.quals:type_name -> proto.DbQual
	3,  // 6: proto.BoolQual.operator:type_name -> proto.BoolQual.Operator
	7,  // 7: proto.BoolQual.quals:type_name -> proto.DbQuals
	10, // 8: proto.QualValueList.values:type_name -> proto.QualValue
	11, // 9: proto.QualValue.inet_value:type_name -> proto.Inet
	30, // 10: proto.QualValue.timestamp_value:type_name -> google.protobuf.Timestamp
	9,  // 11: proto.QualValue.list_value:type_name -> proto.QualValueList
	5,  // 12: proto.Quals.quals:type_name -> proto.Qual
	26, // 13: proto.QueryContext.quals:type_name -> proto.QueryContext.QualsEntry
	27, // 14: proto.QueryContext.db_quals:type_name -> proto.QueryContext.DbQualsEntry
	13, // 15: proto.ExecuteRequest.query_context:type_name -> proto.QueryContext
	20, // 16: proto.ExecuteResponse.row:type_name -> proto.Row
	23, // 17: proto.GetSchemaResponse.schema:type_name -> proto.Schema
	28, // 18: proto.Row.columns:type_name -> proto.Row.ColumnsEntry
	25, // 19: proto.TableSchema.columns:type_name -> proto.ColumnDefinition
	22, // 20: proto.TableSchema.getCallKeyColumns:type_name -> proto.KeyColumnsSet
	22, // 21: proto.TableSchema.listCallKeyColumns:type_name -> proto.KeyColumnsSet
	22, // 22: proto.TableSchema.listCallOptionalKeyColumns:type_name -> proto.KeyColumnsSet
	29, // 23: proto.Schema.schema:type_name -> proto.Schema.SchemaEntry
	0,  // 24: proto.Column.null_value:type_name -> proto.NullValue
	30, // 25: proto.Column.timestamp_value:type_name -> google.protobuf.Timestamp
	1,  // 26: proto.ColumnDefinition.type:type_name -> proto.ColumnType
	12, // 27: proto.QueryContext.QualsEntry.value:type_name -> proto.Quals
	7,  // 28: proto.QueryContext.DbQualsEntry.value:type_name -> proto.DbQuals
	24, // 29: proto.Row.ColumnsEntry.value:type_name -> proto.Column
	21, // 30: proto.Schema.SchemaEntry.value:type_name -> proto.TableSchema
	16, // 31: proto.WrapperPlugin.GetSchema:input_type -> proto.GetSchemaRequest
	14, // 32: proto.WrapperPlugin.Execute:input_type -> proto.ExecuteRequest
	18, // 33: proto.WrapperPlugin.SetConnectionConfig:input_type -> proto.SetConnectionConfigRequest
	17, // 34: proto.WrapperPlugin.GetSchema:output_type -> proto.GetSchemaResponse
	15, // 35: proto.WrapperPlugin.Execute:output_type -> proto.ExecuteResponse
	19, // 36: proto.WrapperPlugin.SetConnectionConfig:output_type -> proto.SetConnectionConfigResponse
...
func file_plugin_proto_init() {
	...
	file_plugin_proto_msgTypes[20].OneofWrappers = []interface{}{
