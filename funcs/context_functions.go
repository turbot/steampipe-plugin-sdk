...
func ContextFunctions() map[string]function.Function {
	...
	ctxFuncs := map[string]function.Function{
		...
		"env":           EnvFunc, // We would import this directly from pipe-fittings once the pipe-fittings package is revamped
	}
